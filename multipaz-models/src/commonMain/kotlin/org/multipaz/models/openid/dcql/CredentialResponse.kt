 ...
 * @property claimValues the claim and values to return.
 */
data class CredentialResponseMatch(
    val credential: Credential,
    val claimValues: List<Pair<DcqlClaim, Claim>>
)

/**
 * A response to a [DcqlCredentialQuery].
 *
 * Since each Credential Query may be satisfied in multiple ways (since the user might have multiple
